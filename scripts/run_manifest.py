...
def case_command(row: dict[str, str]) -> list[str]:
    return [
        ...
        "--marginal-strength", row["marginal_strength"],
        "--marginal-epsilon", row["marginal_epsilon"],
        "--marginal-target-a", row["marginal_target_a"],
        "--marginal-target-b", row["marginal_target_b"],
        "--log-fitness-00", row["log_fitness_00"],
        "--log-fitness-01", row["log_fitness_01"],
        "--log-fitness-10", row["log_fitness_10"],
        "--log-fitness-11", row["log_fitness_11"],
